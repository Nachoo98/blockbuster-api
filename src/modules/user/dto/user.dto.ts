...
export class UserDto {
    ...
    @ApiProperty({ example: '2025-03-27T12:00:00.000Z', description: 'Fecha de creación' })
    @Expose()
    createdAt: Date;

    @ApiProperty({ example: '2025-03-27T12:00:00.000Z', description: 'Fecha de actualización' })
    @Expose()
    updatedAt: Date;
}
